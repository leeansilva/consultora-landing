...
export default function Hero() {
    return (
        <Box h={'max-content'} bg={'blue.700'} pt={'70px'} pb={'70px'}>
            <Container maxW={'6xl'}>
                <Center>
                    <HStack flexDir={{ base: 'column', md: 'row' }} color={'white'}>
                        <Box>
                            <Text fontSize={'7xl'} fontWeight={800}>Diseño web</Text>
                            <Text color={'green.200'} fontSize={'7xl'} fontWeight={800}>100% a medida.</Text>
                            ...
                            <Button colorScheme='green'>Contactanos</Button>
                        </Box>
